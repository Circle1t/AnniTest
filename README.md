...
**当前AnniTest插件版本已经落后于最新定制化插件 Annihilation-X，很多bug已经在最新版本里修了，但最新版本暂不开源！！**

**了解情况去B站看最新公告！！！**

**如果有服主想使用 核心战争优化 + 更多职业 版本（非Anni-X版本），请联系我，并请我喝一杯奶茶~~**

![游戏实况1](.\images\游戏实况1.png)

![游戏实况3](.\images\游戏实况3.png)

![游戏实况4](.\images\游戏实况4.png)

欢迎关注我的个人博客：[Circle1t](https://circle1t.top)（域名目前闲置，打不开正常~）
...
> **项目已在 高版本（非常推荐！ 暂不公布IP） 服务器进行内测（独立版本 Annihilation-X ）**
>
> 项目已在 梦天涯（公益服 IP: tiancraft.cn） 服务器开放测试（服务器目前暂停小游戏部分）
>
> 项目已在 梦想天堂（IP: mc244.com） 服务器开放测试（服务器没有维护此小游戏）
...
* 地图添加方式请参考地图模块部分说明
* NexusAntiCheat类 没有开源！！请删除相关引用代码后再package
